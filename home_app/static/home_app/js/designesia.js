 ...
 (function($) {
    ...
    function init_de() {
        ...
        jQuery("#selector .opt").on("click", function() {
            ...
            jQuery("#colors").attr("href", 'static/home_app/css/colors/' + color + '.css');
            jQuery(this).addClass("active");
        ...
        if (rtl_mode === "on") {
            ...
            jQuery("#bootstrap").attr("href", 'static/home_app/css/bootstrap.rtl.min.css');
            jQuery("#bootstrap-grid").attr("href", 'static/home_app/css/bootstrap-grid.rtl.min.html');
            jQuery("#bootstrap-reboot").attr("href", 'static/home_app/css/bootstrap-reboot.rtl.min.html');
            jQuery("#mdb").attr("href", 'static/home_app/css/mdb.rtl.min.css');
        ...
        jQuery("#selector #demo-rtl").on("click", function() {
            ...
            switch (iteration) {
                ...
                case 2:
                    ...
                    jQuery("#bootstrap").attr("href", 'static/home_app/css/bootstrap.min.css');
                    jQuery("#bootstrap-grid").attr("href", 'static/home_app/css/bootstrap-grid.min.html');
                    jQuery("#bootstrap-reboot").attr("href", 'static/home_app/css/bootstrap-reboot.min.html');
                    jQuery("#mdb").attr("href", 'static/home_app/css/mdb.min.css');
    ...
    jQuery(document).ready(function() {
        ...
        if (c_scheme != undefined) {
            jQuery("#colors").attr("href", 'static/home_app/css/colors/' + c_scheme + '.css');
            jQuery(this).addClass("active");
